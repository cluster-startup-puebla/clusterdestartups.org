...
- **Codear y avanzar**: retomar un proyecto pausado y empujarlo con Cursor.
- **Conectar**: abierto a founders, CEOs y perfiles no técnicos, no solo a desarrolladores.
- **Feedback real**: mostrar lo que se está construyendo, resolver dudas técnicas y ver el flujo de trabajo de otros de cerca.
- **Comunidad**: encontrarse con quienes mueven la tecnología en Puebla en ambiente relajado.

Hubo café y té de cortesía, y se regalaron **créditos de Cursor** para usar funciones Pro durante el evento, canjeables en el momento con la laptop de cada participante.

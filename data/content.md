# Sitemap y Contenido — clusterdestartups.org
...
**Contenido:** 3–4 datos verificables: makers/empresas activas, m² del Hub, número de nodos, industrias/cámaras vinculadas. Separar claramente cifras "hoy" vs. metas "a 2030".

_(Sin foto — solo tipografía grande + iconografía simple.)_

### 1.3 Qué es CSI (resumen)
...
**Contenido:** Invitación a unirse (makers) o colaborar (gobierno/academia/empresa), dos botones según perfil.
...
**Contenido:** Nombre legal completo, RFC (CSI260615EM5), fecha de constitución. Ficha técnica al pie de página.
...
**Contenido:** Nota breve sobre separación entre autoridad operativa y representación legal.
...
**Contenido:** CTA para agendar visita al Hub.
...
**Contenido:** Modelo de expansión geográfica: colaboración recíproca sin transferencias monetarias en el primer año.
...
**Contenido:** CTA para instituciones del interior del estado.
...
**Contenido:** Resumen simplificado de tiers (M0–M7, E1–E3) en lenguaje llano, sin tabla completa de precios.

_(Sin foto — infografía/tabla de niveles.)_

### 7.3 Cómo aplicar

**Contenido:** Pasos del proceso de aplicación + formulario o contacto.

_(Sin foto.)_

---

## 8. Sala de prensa / Anuncios

### 8.1 Comunicados y presencia pública
...
- **Presentación del CSI en Sinergia Clústeres Puebla** — evento por realizarse; redactar la ficha después con hechos verificables.
...
### 9.1 Formulario único con selector de perfil

**Contenido:** Select: "Quiero ser maker/empresa", "Represento gobierno/academia/industria", "Soy prensa", "Otro".

_(Sin foto.)_

### 9.2 Datos de ubicación

**Contenido:** Dirección del Hub, mapa embebido, redes sociales oficiales.

_(Sin foto — el mapa embebido cubre esa función.)_

---

## Notas de alcance — qué NO va en el sitio público

- Estructura y arquitectura legal del fondo de inversión (Armando Gala) — confidencial hasta decisión de vocería institucional.
- Proyecto de ventanilla digital/software (~$5M MXN) y su protocolo de conflicto de interés — exclusivamente interno.
- Detalle completo de los 42 componentes del mapa de ecosistema y documentos de 10 secciones por espacio — material interno.
- Detalle completo de los 42 componentes del mapa de ecosistema y documentos de 10 secciones por espacio — material interno.
- Blog editorial con cadencia regular de análisis de mercado — el contenido informal (workshops, convocatorias, historias de comunidad) vive en `/blog` con la categoría "Comunidad"; los comunicados institucionales viven como categoría "Sala de prensa" del mismo pipeline markdown (`content/blog/*.md`), aparecen en `/prensa` y enlazan a `/blog/[slug]` con JSON-LD NewsArticle. La Sala de prensa mantiene la regla de hechos reales verificables; la Comunidad permite tono más cercano.

---

## Resumen de navegación principal (header)

```
Inicio · Quiénes somos · Gobernanza · El Hub · Nodos · Alianzas · Membresías · Sala de prensa · Contacto
```

Agrupación sugerida si el menú se siente largo: submenú "Sobre CSI" (Quiénes somos + Gobernanza) y "Ecosistema" (El Hub + Nodos + Alianzas); Membresías, Sala de prensa y Contacto quedan de primer nivel por ser los de mayor intención de acción.
